...
namespace Clouded.Platform.Database.Migrations
{
    ...
    [Migration("20231213193005_AddBranchToFunctionProviderConfiguration")]
    partial class AddBranchToFunctionProviderConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clouded.Platform.Database.Entities.Clouded.AdminProviderFunctionRelationEntity", b =>
                {
                    ...
                    b.HasKey("FunctionId", "AdminProviderId", "OperationType");

                    b.HasIndex("AdminProviderId");

                    b.ToTable("provider_admin_function_relation");
                });

            modelBuilder.Entity("Clouded.Platform.Database.Entities.Clouded.AdminProviderTableFunctionRelationEntity", b =>
                {
                    b.Property<long>("FunctionId")
                        .HasColumnType("bigint")
                        .HasColumnName("function_id");

                    b.Property<long>("AdminProviderTableId")
                        .HasColumnType("bigint")
                        .HasColumnName("admin_provider_table_id");

                    b.Property<int>("OperationType")
                        .HasColumnType("integer")
                        .HasColumnName("operation_type");

                    b.HasKey("FunctionId", "AdminProviderTableId", "OperationType");

                    b.HasIndex("AdminProviderTableId");

                    b.ToTable("provider_admin_table_function_relation");
                });
            ...
            modelBuilder.Entity("Clouded.Platform.Database.Entities.Clouded.FunctionEntity", b =>
                {
                    ...
                    b.ToTable("configurations_function_hooks");
                });
            ...
            modelBuilder.Entity("Clouded.Platform.Database.Entities.Clouded.AdminProviderTableFunctionRelationEntity", b =>
                {
                    b.HasOne("Clouded.Platform.Database.Entities.Clouded.AdminTablesConfigurationEntity", "AdminProviderTable")
                        .WithMany("FunctionsRelation")
                        .HasForeignKey("AdminProviderTableId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Clouded.Platform.Database.Entities.Clouded.FunctionEntity", "Function")
                        .WithMany("UsingAdminProviderTablesRelation")
                        .HasForeignKey("FunctionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AdminProviderTable");
            ...
            modelBuilder.Entity("Clouded.Platform.Database.Entities.Clouded.AdminTablesConfigurationEntity", b =>
                {
                    b.Navigation("FunctionsRelation");
                });
            ...
            modelBuilder.Entity("Clouded.Platform.Database.Entities.Clouded.FunctionEntity", b =>
                {
                    b.Navigation("UsingAdminProviderTablesRelation");
